...
public extension YYHud {
	...
	@discardableResult
	static func showLoading(with text: String? = nil, options: OptionInfo = [.modal], in view: UIView? = nil) -> YYHud {
	...
	@discardableResult
	static func show(_ type: DisplayType, options: OptionInfo = [], in view: UIView? = nil) -> YYHud {
...
public final class YYHud: UIView {
	...
	private lazy var contentView: ContentView = {
		...
		v.layoutWidth(min: width/5)
		v.layoutHeight(min: 30)
...
public extension YYHud {
	@discardableResult
    func show(_ type: DisplayType, options: OptionInfo = [], in view: UIView? = nil) -> YYHud {
		config(with: view)
		config(with: type)
		config(with: options)
